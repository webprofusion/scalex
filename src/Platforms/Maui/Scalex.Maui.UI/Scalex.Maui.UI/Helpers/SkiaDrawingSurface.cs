...
namespace Scalex
{
    public class SkiaDrawingSurface : IGenericDrawingSurface
    {
        ...
        {
            // var foregroundThemeColor = (App.Current.Resources["PrimaryTextColor"]).ToSKColor();
            //var mutedForegroundThemeColor = (App.Current.Resources["MutedForegroundColor"]).ToSKColor();
            var foregroundThemeColor = new ColorValue(255, 255, 255);
            var mutedForegroundThemeColor = new ColorValue(128, 128, 128);
            surface.ColorPalette[ThemeColorPreset.ForegroundText] = foregroundThemeColor;
            surface.ColorPalette[ThemeColorPreset.Foreground] = foregroundThemeColor;
            surface.ColorPalette[ThemeColorPreset.MutedForeground] = mutedForegroundThemeColor;
            surface.ColorPalette[ThemeColorPreset.TextShadow] = mutedForegroundThemeColor;
        }
